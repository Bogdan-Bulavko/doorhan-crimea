...
export default function NewArticlePage() {
  ...
  return (
    <div className="grid gap-6">
      <h1 className="text-2xl font-bold text-[#00205B]">Добавить статью</h1>
      {error && (
      ...
      <div className="rounded-xl border bg-white p-4 grid gap-4">
        ...
        <div>
          ...
          <textarea
            ...
            placeholder="Содержимое статьи (можно использовать Markdown)"
          />
        </div>
        <div>
          <SingleImageUpload
        ...
        <div>
          ...
          <input
            ...
            placeholder="ворота, автоматика, установка"
          />
        </div>
